public class kodutoo{
	double a, b, c;
	public kodutoo(double kylg1, double kylg2, double kylg3){
	...
	public String k6rgus(){
		double p=(a+b+c)/2;
		double H=((a/2)*Math.sqrt(p*(p-a)*(p-b)*(p-c)));
		return "Kolmnurga k6rgus H on "+Math.round(H);
	}
